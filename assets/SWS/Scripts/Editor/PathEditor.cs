...
public class PathEditor : Editor
{
    ...
    private SerializedProperty m_Color3;
    //serialized waypoint prefab gameobject
    ...
    public void OnEnable()
    {
        ...
        //for example here we set our serialized checkbox and color properties
        ...
        m_Color3 = m_Object.FindProperty("color3");

        m_WaypointPref = m_Object.FindProperty("waypointPrefab");
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(m_Color3);
    ...
    private void ReplaceWaypoints()
    {
        ...
        for (int i = 0; i < m_WaypointsCount.intValue; i++)
        {
            ...
            else if (i == m_WaypointsCount.intValue-1)
